  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${
        isDarkMode ? "bg-gray-900" : "bg-gradient-to-b from-gray-100 to-white"
      }`}
    >
      {/* Navigation */}
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        >
          ...
          >
            Effortlessly upload, manage, and showcase your product images with
            our interactive image carousel
          </p>
        </motion.header>
